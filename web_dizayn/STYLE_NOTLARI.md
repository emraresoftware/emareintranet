# Emare Intranet — Tasarım Rehberi (Design System)
...
| Token | HEX | Kullanım |
|-------|-----|----------|
| `brand-50` | `#f4f8fa` | Çok açık arka plan, hover bg |
| `brand-100` | `#e8f2f6` | Açık arka plan |
| `brand-200` | `#c6e3ef` | Border (secondary buton) |
| `brand-300` | `#8dceeb` | İkon accent |
| `brand-400` | `#50bbeb` | Hover accent |
| `brand-500` | `#0eaaf0` | **Ana marka rengi (Primary)** |
| `brand-600` | `#0c8fca` | Hover/active primary |
| `brand-700` | `#0575a7` | Koyu primary |
| `brand-800` | `#045980` | Koyu bg accent |
| `brand-900` | `#053d56` | Çok koyu bg |
| `brand-950` | `#04212e` | En koyu bg (hero, footer) |
...
### Primary Buton
```css
background: linear-gradient(to right, #0eaaf0, #0575a7);
```

### Gradient Text
```css
background: linear-gradient(135deg, #0c8fca, #50bbeb);
...
### Hero Koyu Arka Plan
```css
background: linear-gradient(-45deg, #04212e, #053d56, #045980);
```
