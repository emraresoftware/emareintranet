# Emare Intranet — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/Emareintranet
...
| 6 | `Emareintranet_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `Emareintranet Dervishi` bu projeden sorumlu
