# Emare Intranet — Dervişin Çeyizi
...
```python
# Emare Intranet — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'Emareintranet.view',      # Görüntüleme
    'Emareintranet.create',    # Oluşturma
    'Emareintranet.edit',      # Düzenleme
    'Emareintranet.delete',    # Silme
    'Emareintranet.manage',    # Tam yönetim
    # Admin
    'Emareintranet.admin',     # Admin panele erişim
    'Emareintranet.users',     # Kullanıcı yönetimi
    'Emareintranet.settings',  # Ayar yönetimi
]
```
...
```python
# Emareintranet/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'Emareintranet.view', 'Emareintranet.create',
        'Emareintranet.edit', 'Emareintranet.delete',
        'Emareintranet.manage', 'Emareintranet.users',
        'Emareintranet.settings', 'Emareintranet.admin',
    },
    'operator': {
        'Emareintranet.view', 'Emareintranet.create',
        'Emareintranet.edit',
...
| Proje Admini | admin@Emareintranet.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@Emareintranet.emare.dev | super_admin | Machine-to-machine |
